...
"")
        ...
        self.lbl_github = QtWidgets.QLabel(AboutDialog)
        self.lbl_github.setStyleSheet("color: white;")
        self.lbl_github.setAlignment(QtCore.Qt.AlignCenter)
        self.lbl_github.setOpenExternalLinks(True)
        self.lbl_github.setObjectName("lbl_github")
        self.verticalLayout_2.addWidget(self.lbl_github)
    ...
    def retranslateUi(self, AboutDialog):
        ...
        self.lbl_github.setText(_translate("AboutDialog", "<html><head/><body><p><br/></p></body></html>"))
